 ...
 *  - Block devices are pre-filtered by the backend (no synchronous fs.existsSync in the renderer).
            ...
            blockList.forEach((e, blockIndex) => {
                ...
                switch(e.type) {
                    ...
                    case "edex-theme":
                        ...
                        type = "eDEX-UI-GO theme";
                        break;
                    case "edex-kblayout":
                        icon = this.edexIcons.kblayout;
                        type = "eDEX-UI-GO keyboard layout";
                        break;
                    case "edex-settings":
                    case "edex-shortcuts":
                        icon = this.edexIcons.settings;
                        type = "eDEX-UI-GO config file";
                        break;
                    case "system":
                        icon = this.edexIcons.settings;
                        break;
                    case "edex-themesDir":
                        ...
                        type = "eDEX-UI-GO themes folder";
                        break;
                    case "edex-kblayoutsDir":
                        icon = this.edexIcons.kblayoutsDir;
                        type = "eDEX-UI-GO keyboards folder";
                        break;
                    default:
